...
public class MGParticles {
    public static final DefaultParticleType MUZZLE_FLASH_PARTICLE = FabricParticleTypes.simple();
    public static final DefaultParticleType SOUND_WAVE_PARTICLE = FabricParticleTypes.simple();

    public static void MainInit() {
        Registry.register(Registries.PARTICLE_TYPE, Identifier.of(MoreGun.MOD_ID, "muzzle_flash"), MUZZLE_FLASH_PARTICLE);
        Registry.register(Registries.PARTICLE_TYPE, Identifier.of(MoreGun.MOD_ID, "sound_wave"), SOUND_WAVE_PARTICLE);
    }

    public static void clientInit() {
        ParticleFactoryRegistry.getInstance().register(MUZZLE_FLASH_PARTICLE, MuzzleFlashParticle.Factory::new);
        ParticleFactoryRegistry.getInstance().register(SOUND_WAVE_PARTICLE, SoundWaveParticle.Factory::new);
    }
}
